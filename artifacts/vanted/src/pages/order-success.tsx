  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-slate-50 p-4">
      <div className="bg-white p-10 md:p-16 rounded-3xl border border-border shadow-xl max-w-xl w-full text-center animate-in zoom-in-95 duration-500">
        ...
        <h1 className="text-4xl font-display font-bold text-slate-900 mb-4">Booking Confirmed!</h1>
        <p className="text-lg text-slate-600 mb-2">Your service has been booked successfully.</p>
        <p className="text-sm text-slate-500 mb-2">Booking ID: <span className="font-mono font-medium text-slate-900">#{orderId}</span></p>
        <p className="text-sm text-slate-500 mb-10">Our team will arrive at your address within the estimated time.</p>
